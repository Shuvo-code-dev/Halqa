...
export const metadata: Metadata = {
  ...
  description: 'Halqa is an open-source educational platform. We respect your privacy and do not track your personal data.',
};
    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '10rem 2rem' }}>
      ...
      <div style={{ color: 'var(--text-secondary)', lineHeight: '1.8', fontSize: '1.1rem' }}>
        <p style={{ marginBottom: '2rem' }}>
          At Halqa, we believe documentation and education should be free of noise and intrusion. 
        ...
        <p>
          Halqa is a static-optimized educational platform. We do not require account creation, 
        ...
        <p>
          ...
          privacy policies, and we encourage you to review them. Halqa itself does not share data with any third-party marketing services.
        </p>
        ...
        <p>
          ...
          <a href="https://github.com/Shuvo-code-dev/Halqa" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)', marginLeft: '5px' }}>GitHub</a>.
        </p>
